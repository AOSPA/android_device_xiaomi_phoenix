...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/rootdir/etc/init.phoenix.performance.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.phoenix.performance.rc
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/rootdir/etc/init.phoenix.nfc.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.phoenix.nfc.rc
